...
setup(
    ...
    packages=['insight_tidy'],
    package_dir={'insight_tidy': 'insight_tidy'},
    entry_points={
        'console_scripts': ['insight_tidy = insight_tidy.insight_tidy:main']
    },
    url='https://github.com/bjpop/insight_tidy',
    license='LICENSE',
