...
this_program_name="insight_tidy-test.sh"
...
${this_program_name}: run integration/regression tests for insight_tidy 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/insight_tidy -d data/tests
